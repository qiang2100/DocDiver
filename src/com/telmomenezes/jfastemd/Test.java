...
public class Test {
    ...
    static double emd()
    {
    	Vector<Double> sen1 = new Vector<Double>();
    	
    	sen1.add(0.4);
    	sen1.add(0.6);
    	
    	Vector<Double> sen2 = new Vector<Double>();
        ...
        double dist = JFastEMD.emdHat(sen1, sen2, vec, 0.0);

        return dist;
    }
    
    public static void computEMD()
	{
		try
		{
			Vector<Double> P = new Vector<Double>();
			
			FileReader pFW = new FileReader("P.txt");
			BufferedReader pBW = new BufferedReader(pFW);
			String line="";
			while ((line = pBW.readLine()) != null) 
			{
				String word[] = line.split(" ");
				
				for(int i=0; i<word.length; i++)
					P.add(Double.parseDouble(word[i]));
			}
			...
			FileReader qFW = new FileReader("Q.txt");
			BufferedReader qBW = new BufferedReader(qFW);
			//String line="";
			while ((line = qBW.readLine()) != null)
			{
				String word[] = line.split(" ");
				
				for(int i=0; i<word.length; i++)
					Q.add(Double.parseDouble(word[i]));
			}
			...
			FileReader cFW = new FileReader("C.txt");
			BufferedReader cBW = new BufferedReader(cFW);
			//String line="";
			while ((line = cBW.readLine()) != null) 
			{
				String word[] = line.split(" ");
				
				Vector<Double> oneV = new Vector<Double>();
				
				for(int i=0; i<word.length; i++)
					oneV.add(Double.parseDouble(word[i]));
			...
			cBW.close();
			 ...
			 double dist = JFastEMD.emdHat(P, Q, C, 0.0);
