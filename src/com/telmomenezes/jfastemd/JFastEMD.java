...
public class JFastEMD {
    ...
    static public double emdHatImplLongLongInt(Vector<Double> Pc, Vector<Double> Qc,
            Vector<Vector<Double>> C, double extraMassPenalty) {
        ...
        double mcfDist = mcf.compute(bb, cc, flows);
    ...
    static public double emdHat(Vector<Double> P, Vector<Double> Q, Vector<Vector<Double>> C,
        ...
        int N = P.size();
        Vector<Double> iP = new Vector<Double>();
        Vector<Double> iQ = new Vector<Double>();
        Vector<Vector<Double>> iC = new Vector<Vector<Double>>();
        for (int i = 0; i < N; i++) {
            iP.add(0.0);
            iQ.add(0.0);
            Vector<Double> vec = new Vector<Double>();
        ...
        for (int i = 0; i < N; i++) {
            iP.set(i, (Double) (Math.floor(P.get(i) * PQnormFactor + 0.5)));
        	//iP.set(i, P.get(i) * PQnormFactor + 0.5);
            iQ.set(i, (Double) (Math.floor(Q.get(i) * PQnormFactor + 0.5)));
        	//iQ.set(i, Q.get(i) * PQnormFactor + 0.5);
            for (int j = 0; j < N; j++) {
                iC.get(i)
                        .set(j,
                                (Double) (Math.floor(C.get(i).get(j)
                                        * CnormFactor + 0.5))); 
            	//iC.get(i).set(j,C.get(i).get(j)* CnormFactor + 0.5);
            }
        }
